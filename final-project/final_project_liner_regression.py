...
print(f"Model's Linear Equation: y={coef[0]}x1 + {coef[1]}x2 + {coef[2]}x3 + {coef[3]}x4 + {coef[4]}x5 + {coef[5]}x6 + {coef[6]}x7 + {coef[7]}x8 + {coef[8]}x9 + {coef[9]}x10 + {coef[10]}x11 + {coef[11]}x12 + {coef[12]}x13 + {coef[13]}x14 + {intercept}")
